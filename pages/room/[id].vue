...
<template>
    <div class="h-screen flex flex-col justify-center relative">
      ...
      <div class="h-[15vh] w-[90vw] lg:w-[50vw] min-w-[300px] mx-auto">
        <!-- <p class="text-center mt-1">Комната "{{ id }}"</p> -->
        <my-input id="username" placeholder="Введите имя">Имя</my-input>
